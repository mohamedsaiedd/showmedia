...
const StripItem = document.querySelector('.navbar');
...
const boxArea = document.querySelector('.box-area ');
        ...
        boxArea.style.top = e.pageY /100 + "px"
        boxArea.style.left = e.pageX /100 + "px"
    
})


// StripItem.addEventListener('mouseup' , function() {
// const boxArea = document.querySelectorAll('.box-area li');
//     boxArea.forEach(function(box) {
//         console.log('number');
